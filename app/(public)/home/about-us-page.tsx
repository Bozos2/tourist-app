        ...
        <div className="flex w-full flex-col items-center justify-center pt-16 sm:pt-0 lg:flex-row lg:gap-16 lg:pt-24">
          ...
          <div className="flex max-w-[300px] flex-col gap-4 sm:max-w-[440px] lg:max-w-[360px] xl:max-w-[500px] 2xl:max-w-[620px]">
            ...
            <p className="opacity-80">
              ...
              new destinations. That&apos;s why we&apos;ve created a
              user-friendly application designed to streamline your travel
              planning process, making your journey as smooth and enjoyable as
              possible. Our platform serves as a hub for travelers to explore
              and review destinations worldwide, connecting you with a global
